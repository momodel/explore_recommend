# Mo-AI 俱乐部第 62 期机器学习学术沙龙邀请函

Mo 人工智能俱乐部正式向感兴趣的小伙伴们发出诚挚的邀请！10月25日（周日），我们将在线上举办第 62 期机器学习学术沙龙。

+ 活动主题：Vision-and-Language 中的联邦学习
+ 活动举办方：Mo人工智能俱乐部
+ 活动方式：线上（Mo平台直播&钉钉直播)
+ 活动时间：10月25日19：30-20：30

### 活动内容
联邦学习的鲁棒性
#### 主讲人
陈玥(浙江大学-在校研究生-软件学院-硕士生-2020)
#### 分享论文
Federated Learning for Vision-and-Language Grounding Problems
#### 大纲
1.什么是Vision-and-Language。 2.Vision-and-Language面临的挑战是什么。 3.如何将联邦学习运用到Vision-and-Language。
#### 引言
在vision-and-language grounding 问题中，多任务模式可以提升每个任务的性能，多任务学习中如何防止数据泄漏是当下研究热点。基于此，本论文提出了基于联邦学习的框架，通过生成细粒度的图像表示，该框架提高了在不需要共享下游任务数据的情况下vision-and-language grounding 问题的性能。我们这次分享的内容是目前该方向的前沿工作。欢迎大家参加。
### 活动地址
钉钉扫码，加入直播群！
