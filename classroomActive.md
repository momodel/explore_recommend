# Mo-AI 俱乐部第 51 期机器学习学术沙龙邀请函

Mo 人工智能俱乐部正式向感兴趣的小伙伴们发出诚挚的邀请！07月26日（周日），我们将在线上举办第 51 期机器学习学术沙龙。

+ 活动主题：Population Based Augmentation
+ 活动举办方：Mo人工智能俱乐部
+ 活动方式：线上（Mo平台直播&钉钉直播)
+ 活动时间：07月26日19：30-21：30


### 活动内容
Population Based Augmentation
#### 主讲人
支广达 浙江大学软件学院 软件工程 研一
#### 分享论文
Population Based Augmentation
#### 大纲
1.背景，
...
#### 引言
数据增强是一种提高现代图像分类器准确率的有效技术。利用数据增强来提高神经网络训练准确率的一个关键挑战是从一个很大的搜索空间中选择一个有效的增强策略。适当的选择增强策略能够很大的提升模型的准确率。本文提出一种基于Population Based Training超参数优化算法的数据增强方法，能够有效的搜索出一个增强策略计划，提升模型的准确率。
