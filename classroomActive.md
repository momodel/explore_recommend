# Mo-AI 俱乐部第 63 期机器学习学术沙龙邀请函

Mo 人工智能俱乐部正式向感兴趣的小伙伴们发出诚挚的邀请！11月01日（周日），我们将在线上举办第 63 期机器学习学术沙龙。

+ 活动主题：联邦半监督学习
+ 活动举办方：Mo人工智能俱乐部
+ 活动方式：线上（Mo平台直播&钉钉直播)
+ 活动时间：11月01日19：30-20：30

### 活动内容
联邦半监督学习
#### 主讲人
余敏君(浙江大学-在校研究生-软件学院-硕士生-2020)
#### 分享论文
Federated Semi-Supervised Learning with Inter-Client Consistency
#### 大纲
1.联邦半监督的应用场景。 2.联邦半监督学习现有工作的介绍。 3.一种应用于联邦无监督场景的算法(FedMatch)介绍。
#### 引言
以往的联邦学习工作往往专注于监督学习任务的研究，即要求所有的数据都必须包含相应的标签。但在现实场景中，本地客户端所包含的数据常常大部分甚至全部都是没有相应的标签的。因此，本次论文分享将会从联邦半监督问题入手，为大家介绍现有的研究工作，并详细介绍一种针对该应用场景的联邦算法FedMatch。我们这次分享的内容是目前该方向的前沿工作。欢迎大家参加。
### 活动地址
钉钉扫码，加入直播群！
