# Mo-AI 俱乐部第 68 期机器学习学术沙龙邀请函

Mo 人工智能俱乐部正式向感兴趣的小伙伴们发出诚挚的邀请！12月06日（周日），我们将在线上举办第 68 期机器学习学术沙龙。

+ 活动主题：联邦学习中的数据定价
+ 活动举办方：Mo人工智能俱乐部
+ 活动方式：线上（Mo平台直播&钉钉直播)
+ 活动时间：12月06日19：30-20：30

### 活动内容
联邦学习中的数据定价
#### 主讲人
胡煜(浙江大学-在校研究生-软件学院-硕士生-2020)
#### 分享论文
Towards Federated Learning at Scale: System Design
#### 大纲
1.如何设计一个联邦学习系统。2.联邦学习系统的实现效果和简单应用。
#### 引言
在2016年谷歌提出Federated Learning概念之后，终于在2019年谷歌实现了全球首个产品级可拓展的大规模移动端Federated Learning，这个系统可以在数千万台安卓手机上搭载并运行以实现联邦学习。在2019年5月8日Google I/O 开发者大会上发布了在Gboard(针对IOS设备和Android设备的虚拟键盘)中广泛应用的一项技术，它能够在用户多次使用相关词之后，在输入时为用户推荐单词和表情。与传统的推荐系统不同，该系统是在不侵犯用户隐私的前提下，极大程度上依赖于移动设备自身完成训练。我们这次分享的内容是目前该方向的前沿工作。欢迎大家参加！！！
### 活动地址
钉钉扫码，加入直播群！
