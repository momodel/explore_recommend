# Mo-AI 俱乐部第 55 期机器学习学术沙龙邀请函

Mo 人工智能俱乐部正式向感兴趣的小伙伴们发出诚挚的邀请！08月30日（周日），我们将在线上举办第 55 期机器学习学术沙龙。

+ 活动主题：Deep & Cross Network
+ 活动举办方：Mo人工智能俱乐部
+ 活动方式：线上（Mo平台直播&钉钉直播)
+ 活动时间：08月30日19：30-21：30
...
4.实验与展望
#### 引言
学习和预测用户的反馈对于个性化推荐、信息检索和在线广告等领域都有着极其重要的作用。在这些领域，用户的反馈行为包括点击、收藏、购买等。以往特征工程是许多预测模型成功的关键。但是，此过程并非易事，并且需要手动进行特征工程或详尽搜索。我们这次分享的论文Deep＆Cross Network（DCN）， 是用复杂网络预估CTR的一种方法，不需要人工特征工程，可以学习某些有界特征交互作用。欢迎大家参加。
### 活动地址
钉钉扫码，加入直播群！
