# Mo-AI 俱乐部第 64 期机器学习学术沙龙邀请函

Mo 人工智能俱乐部正式向感兴趣的小伙伴们发出诚挚的邀请！11月08日（周日），我们将在线上举办第 64 期机器学习学术沙龙。

+ 活动主题：联邦学习中的数据定价
+ 活动举办方：Mo人工智能俱乐部
+ 活动方式：线上（Mo平台直播&钉钉直播)
+ 活动时间：11月08日19：30-20：30

### 活动内容
联邦学习中的数据定价
#### 主讲人
焦令炜(浙江大学-在校研究生-软件学院-硕士生-2020)
#### 分享论文
A Principled Approach to Data Valuation for Federated Learning
#### 大纲
1.数据定价在联邦学习中的应用场景。 2.数据定价中常见的一种定价算法Shapley value。 3.定价算法的改进(federated Shapley value)介绍。
#### 引言
在联邦场景下，客户端用自己的数据训练模型，每个客户端对模型的贡献如何来衡量？为了能激励客户端长期参与训练，重点在于公平的评价客户端的贡献并给予相应的补偿。本次论文分享将会介绍在联邦学习中评价客户端（数据提供者）的贡献的一种算法Shapley value及其变种federated Shapley value，以及在联邦学习中的应用。我们这次分享的内容是目前该方向的前沿工作。欢迎大家参加！！！
### 活动地址
钉钉扫码，加入直播群！
